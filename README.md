...
This repository currently contains planning documents, project configuration, typed config loading/validation, GitHub OAuth authorization URL construction, callback state validation, code-to-token exchange helpers, authenticated GitHub user identity lookup, and a minimal Rust binary scaffold. The actual CLI/server behavior has not been implemented yet.
