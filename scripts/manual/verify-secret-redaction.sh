...
redaction_tests=(
  "cli::init::tests::init_summary_redacts_sensitive_previous_lfs_url"
  "cli::status::tests::status_redacts_unsafe_server_override_before_route_validation"
  "cli::status::tests::status_reports_failures_without_leaking_credential_secrets"
  ...
  "google_drive::diagnostics_tests::drive_diagnostics_redact_token_fragments_at_truncation_boundary"
  "server_config::config::tests::raw_repository_provider_debug_redacts_github_personal_access_token"
  "server_config::config::tests::server_config_debug_redacts_github_personal_access_token"
...
case "$(uname -s)" in
  ...
  *)
    redaction_tests+=(
      ...
      "google_drive::access_token_tests::gcloud_provider_redacts_failed_command_stderr"
    )
    ;;
esac
