...
1. **IS IT BROKEN?**
   ...
   - Route: `ACTIVATE_SKILL: rust-lint-hunter`
   - _Special Case_: If it's a "Syntax Error" or "missing semicolon", Route: `ACTIVATE_SKILL: rust-syntax`.

2. **IS IT PARSING?**
   - Keywords: "parse", "grammar", "rule", "PEG", "pest"
   - Route: `ACTIVATE_SKILL: rust-pest`

3. **IS IT CONFIGURATION?**
   - Keywords: "config", "settings", "ron", "serialize", "save/load"
   - Route: `ACTIVATE_SKILL: rust-ron`

4. **IS IT SECURITY?**
   - Keywords: "audit", "unsafe", "vulnerability", "check secrets"
   - Route: `ACTIVATE_SKILL: rust-security`

5. **DEFAULT: BUILD/REFACTOR**
   - Keywords: "create", "implement", "add feature", "change logic"
   - Route: `ACTIVATE_SKILL: rust-core`
